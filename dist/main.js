...
class Tube extends _GameObject__WEBPACK_IMPORTED_MODULE_2__.GameObject {
  constructor(options) {
    options = _extensions_Utils__WEBPACK_IMPORTED_MODULE_1__.$safe.call({}, options, { gap: 200 });
    super(options);
