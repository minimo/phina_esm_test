...
/* harmony import */ var _extensions_Utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../extensions/Utils */ "./src/extensions/Utils.js");
...
class MainScene extends phina_js_build_phina_esm__WEBPACK_IMPORTED_MODULE_0__.DisplayScene {
  ...
  constructor(options) {
    options = _extensions_Utils__WEBPACK_IMPORTED_MODULE_3__.$safe.call({}, options, { backgroundColor: 'black' });
    super(options);

    this.isStart = false;

    //バックグラウンド
    this.background = new phina_js_build_phina_esm__WEBPACK_IMPORTED_MODULE_0__.Sprite("background").addChildTo(this).setOrigin(0, 0);
