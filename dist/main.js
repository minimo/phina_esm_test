...
class CountDown extends _GameObject__WEBPACK_IMPORTED_MODULE_2__.GameObject {
  constructor(options) {
    options = _extensions_Utils__WEBPACK_IMPORTED_MODULE_1__.$safe.call({}, options, { startCount: 3, interval: 2000, startScale: 3 });
    super(options);

    this.count = options.startCount;

    this.label = new phina_js_build_phina_esm__WEBPACK_IMPORTED_MODULE_0__.Label(`${this.count}`)
      .setScale(options.startScale)
      .addChildTo(this);

    this.label.tweener.clear();
    _extensions_Utils__WEBPACK_IMPORTED_MODULE_1__.times.call(options.startCount, () => {
      this.label.tweener
...
class MainScene extends phina_js_build_phina_esm__WEBPACK_IMPORTED_MODULE_0__.DisplayScene {
  constructor(options) {
    ...
    new phina_js_build_phina_esm__WEBPACK_IMPORTED_MODULE_0__.Sprite("background").addChildTo(this).setOrigin(0, 0);
